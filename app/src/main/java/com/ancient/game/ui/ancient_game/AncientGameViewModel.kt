...
import com.ancient.game.core.library.l
import com.ancient.game.domain.ancient_game.AncientGameRepository
...
class AncientGameViewModel : ViewModel() {
    private val repository = AncientGameRepository()
    ...
    private val _moves = MutableLiveData(40)
    ...
    private fun firstCheckout(selectedItemPosition: Int, clickedItemPosition: Int) {
        viewModelScope.launch {
            ...
            if (indexesToRemove.isNotEmpty() && currentList[selectedItemPosition].imgValue != currentList[clickedItemPosition].imgValue) {
                ...
                if (imgValue == 1) {
                    _task1.postValue(if (_task1.value!! + indexesToRemove.size <= 15) _task1.value!! + indexesToRemove.size else 15)
                }

                if (imgValue == 6) {
                    _task2.postValue(if (_task2.value!! + indexesToRemove.size <= 15) _task2.value!! + indexesToRemove.size else 15)
                }

                if (imgValue == 4) {
                    _task3.postValue(if (_task3.value!! + indexesToRemove.size <= 15) _task3.value!! + indexesToRemove.size else 15)
                }

                if (imgValue == 3) {
                    _task4.postValue(if (_task4.value!! + indexesToRemove.size <= 15) _task4.value!! + indexesToRemove.size else 15)
                }
            }
            ...
            if (indexesToRemove2.isNotEmpty() && currentList[selectedItemPosition].imgValue != currentList[clickedItemPosition].imgValue) {
                ...
                if (imgValue == 1) {
                    _task1.postValue(if (_task1.value!! + indexesToRemove2.size <= 15) _task1.value!! + indexesToRemove2.size else 15)
                }

                if (imgValue == 6) {
                    _task2.postValue(if (_task2.value!! + indexesToRemove2.size <= 15) _task2.value!! + indexesToRemove2.size else 15)
                }

                if (imgValue == 4) {
                    _task3.postValue(if (_task3.value!! + indexesToRemove2.size <= 15) _task3.value!! + indexesToRemove2.size else 15)
                }

                if (imgValue == 3) {
                    _task4.postValue(if (_task4.value!! + indexesToRemove2.size <= 15) _task4.value!! + indexesToRemove2.size else 15)
                }
            }
            ...
            if (indexesToRemove2.isNotEmpty() && indexesToRemove.isNotEmpty() && currentList[selectedItemPosition].imgValue == currentList[clickedItemPosition].imgValue) {
                ...
                val imgValue = currentList[clickedItemPosition].imgValue
                if (imgValue == 1) {
                    _task1.postValue(if (_task1.value!! + newIndexes.size <= 15) _task1.value!! + newIndexes.size else 15)
                }

                if (imgValue == 6) {
                    _task2.postValue(if (_task2.value!! + newIndexes.size <= 15) _task2.value!! + newIndexes.size else 15)
                }

                if (imgValue == 4) {
                    _task3.postValue(if (_task3.value!! + newIndexes.size <= 15) _task3.value!! + newIndexes.size else 15)
                }

                if (imgValue == 3) {
                    _task4.postValue(if (_task4.value!! + newIndexes.size <= 15) _task4.value!! + newIndexes.size else 15)
                }
            }
